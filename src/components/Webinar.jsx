...
>>>>>>> 19880f89ed1b5fd953bb50023ae7f8c882a7a5f3
  ...
  // Step 3: Handle Razorpay payment after registration
  const handleRazorpayPayment = async () => {
    setIsLoading(true);
    ...
    try {
      ...
      if (response.status === 200) {
        const options = {
          key: 'rzp_live_oRtGw5y3RbD9MH', // Razorpay Key
          amount: formData.amount * 100,
          currency: 'INR',
          name: 'TSAR-IT',
  ...
  return (
    <>
      <main className="animation" style={{display:'flex', alignItems:'center'}}>
        ...
        <MdOutlineKeyboardArrowRight />
        <span className="pages">Webinar</span>
      </main>
      ...
      <div className="webinarrr-container">
        <div className="webinarrr-content-highlight">
          ...
          <p>
            Join our comprehensive internship webinar to kickstart your career in the tech industry.
            This webinar will cover trending topics and provide hands-on experience with real-world projects.
          </p>
          <h3>Key Topics Covered:</h3>
          <ul className="webinarrr-topics">
            <li>Introduction to Programming Java Fullstack</li>
          ...
          <p>Register now to secure your spot in the webinar.</p>
        </div>
              ...
              <div className="webinarrr-form-group webinarrr-checkbox-group">
                <label className="webinarrr-checkbox-label">
                  <input
                    ...
                    className="webinarrr-checkbox"
                  />
                  <span className="webinarrr-accept-terms">I agree to the terms and conditions</span>
                </label>
              </div>

              <button type="submit" className="webinarrr-btn" disabled={isLoading}>
                {isLoading ? 'Processing...' : 'Register'}
              </button>
            </form>
          </div>
        ) : (
          <div className="webinarrr-payment">
            ...
            <button onClick={handleRazorpayPayment} className="webinarrr-btn" disabled={isLoading}>
